...
public class FragmentBuildOrderTerran extends Fragment {


    RecyclerView recyclerViewBuilds;
    RecyclerView.LayoutManager layoutManager;
    RecyclerAdapterBuildOrderTerran adapterBuilds;

    private String[] titles = {"Gundam Rush",
            "1 Fact FE",
            "2 Rax Tech",
            "8 Rax",
            "Ayumi Build"
    ...
    public FragmentBuildOrderTerran() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapterBuilds = new RecyclerAdapterBuildOrderTerran(getActivity().getApplicationContext(), titles);
