...
public class RecyclerAdapterBuildOrderTerran extends RecyclerView.Adapter<RecyclerAdapterBuildOrderTerran.ViewHolder> {

    private Context mContext;
    String[] titles;
    FragmentBuildOrderDescription fragmentBuildOrderDescription = new FragmentBuildOrderDescription();

    public RecyclerAdapterBuildOrderTerran(Context contexts, String[] titles) {
        ...
        holder.setClickListener(new ItemClickListener() {
            ...
            public void onClick(View view, int pos, boolean isLongClick) {
                if (pos == 0) {
                    ...
                    bundle.putString("build","gundamrush");
                    ...
                    Bundle bundle = new Bundle();
                    bundle.putString("build","1factfe");
                    fragmentBuildOrderDescription.setArguments(bundle);
                    ((FragmentActivity) view.getContext()).getFragmentManager().beginTransaction()
                            .replace(R.id.home_layout, fragmentBuildOrderDescription).addToBackStack(null)
                            .commit();
                    ...
                    Bundle bundle = new Bundle();
                    bundle.putString("build","2raxtech");
                    fragmentBuildOrderDescription.setArguments(bundle);
                    ((FragmentActivity) view.getContext()).getFragmentManager().beginTransaction()
                            .replace(R.id.home_layout, fragmentBuildOrderDescription).addToBackStack(null)
                            .commit();
                    ...
                    Bundle bundle = new Bundle();
                    bundle.putString("build","ayumibuild");
                    fragmentBuildOrderDescription.setArguments(bundle);
                    ((FragmentActivity) view.getContext()).getFragmentManager().beginTransaction()
                            .replace(R.id.home_layout, fragmentBuildOrderDescription).addToBackStack(null)
                            .commit();
